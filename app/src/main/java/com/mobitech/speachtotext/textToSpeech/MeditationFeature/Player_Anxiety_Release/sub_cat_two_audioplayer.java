...
public class sub_cat_two_audioplayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_cat_two_audioplayer);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(sub_cat_two_audioplayer.this, Cate_Anxiety_Release.class);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.overcominganxietyandfear);
