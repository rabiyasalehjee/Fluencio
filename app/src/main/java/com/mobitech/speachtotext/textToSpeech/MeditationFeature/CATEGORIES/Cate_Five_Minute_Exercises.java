...
public class Cate_Five_Minute_Exercises extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cate_five_min_exercise);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cate_Five_Minute_Exercises.this, MeditationDashBoardActivity.class));
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.reducefearofpublicspeaking);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.calminganxietyreduction);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.exercisetorelievestress);
