...
public class Cate_Relaxing_Music extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cate__relaxing_music);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cate_Relaxing_Music.this, MeditationDashBoardActivity.class));
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.threeminrelaxingmusic);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.fiveminutesrelaxingmusic);
